...
public class Main extends Application {
	...
	private void aboutMe() {
		...
		alert.setHeaderText("Rajesh M");
		alert.setContentText("Rajesh is currently working as a freelancer in creating Java" +
				"and Python applications, and is always interested in a challenge." +
				"Reach out to *****.***********@gmail.com to connect!");
		alert.show();
	}
